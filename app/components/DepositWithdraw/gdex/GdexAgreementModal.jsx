                ...
                return (
                    ...
                    >
                        ...
                        <p>
                            ...
                            是一家根据新加坡共和国法律成立的公司，GDEX是由该公司运营的DNA网关(以下称“GDEX”或“本网关”)，主访问入口为https://www.gdex.io，GDEX是一个在DNA平台为用户提供数字资产充提服务（以下称“该服务”或“服务”）的平台。为了本协议表述之方便，公司和该网关在本协议中合称使用“我们”或其他第一人称称呼。使用该服务的自然人或其他主体均为本网关的用户，本协议为表述之便利，以下使用“您”或其他第二人称。我们和您在本协议中合称为“双方”，我们或您单称为“一方”。
                        </p>
                        <p>重要提示：</p>
                        <p>我们在此特别提醒您：</p>
                        <p>
                        ...
                        <p>敬告您：</p>
                        <p>
                            1.您了解DNA是基于区块链的去中心化交易平台，其基础账号服务和交易撮合服务都由DNA平台提供。亦有其它机构或个人在DNA平台上发行资产及／或提供服务。您了解本网关仅作为您向DNA平台充提数字资产的工具。本网关只对自身发行的交易代币资产（名称以GDEX.为前缀）负责，不对DNA上其它机构或个人发行的资产负责，本网关不参与您的任何交易，您应自行谨慎判断确定相关数字资产及/或信息的真实性、合法性和有效性，并自行承担因此产生的责任与损失。
                        </p>
                        <p>
                            {" "}
                            2.
                            DNA去中心化交易系统存有风险，包括但不限于软件，硬件和互联网链结的失败，用户账户系统的安全风险等。由于我们不能控制互联网以及DNA平台的可靠性和可用性，我们不会对上述风险造成的用户损失承担任何责任。
                        </p>
                        <p>
                            {" "}
                            3.
                        ...
                        <p>三、服务</p>
                        <p>
                            本网关只为您提供向DNA平台冲入和提取数字资产的服务，本网关并不作为买家或卖家参与买卖数字资产行为本身；本网关不提供任何国家法定货币充入和提取的相关服务。
                        </p>
                        <p> 3.1 服务内容</p>
                        <p>
                            {" "}
                            3.1.1 您有权通过本网关向DNA平台冲入或提取数字资产。
                        </p>
                        ...
                        <p>
                            {" "}
                            3.2.2
                            您在使用本网关服务之前应充分了解DNA账号的使用常识，做好相应账号的备份及密码保存工作，对于DNA账户安全问题造成的损失，本网关不承担任何责任。
                        </p>
                        <p>
                            {" "}
                            3.2.3
                ...
                return (
                    ...
                    >
                        ...
                        <p>
                            ...
                            Gateway') is a cryptocurrency gateway to DNA which
                            ...
                            DNA. For the convenience of wording in this
                        ...
                        <p>
                            ...
                            DNA, do not undertake the due obligations for
                            availability of the assets issued by other
                            institutions or single persons.{" "}
                        </p>
                        <p>
                            6. There are risk in both Internet and DNA, include
                            but not limit to failure for software, hardware to
                            connect to Internet, security risk for DNA
                            accounting system. As the availability and
                            reliability of Internet and DNA are not under our
