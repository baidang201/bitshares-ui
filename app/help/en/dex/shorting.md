...
In order to increase your exposure to DNA and offer liquidity to BitAssets, such
...
The DNA network is capable of issuing any amount of any BitAsset and lend
it out to participants given enough collateral.

 * *settlement price*: The price for 1 DNA as it is traded on external exchanges.
...
The DNA network is capable of margin calling those positions that do not
...
offer to buy the collateral is less than the call price (x/DNA).
...
market rates up to the SQP and close the position. The remaining DNA of the
...
increase, an additional amount of DNA is locked as collateral, while reducing
...
particular bitAsset to hand it over to the DNA network. After that, the
