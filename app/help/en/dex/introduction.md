...
direct exchange of digital goods traded in the DNA ecosystem.
...
briefly below. Although the DNA DEX comes with all of them, it is up to
...
* **Separation of Powers**: 
  ...
  issuing IOUs and for processing the order book. In DNA, order matching
  is performed by the protocol, which is unaware of implications concerning the
  involved assets.
  
* **Global Unified Order Book**:
  Since DNA is global, anybody with an internet access can use the DEX for
  trading. This brings the world's liquidity to a single order book for
  decentralized trading.
  
* **Trade Almost Anything**:
  The DNA DEX is asset agnostic. Hence you can trade at **any** pair.
...
* **No Limits**:
  The DNA protocol is unable to limit your trading experience.
  
* **Decentralized**:
  The DEX is decentralized across the globe. This not only means that there is
  no single point of failure, but it also implies that the DNA exchange is
...
* **Fast**:
  In contrast to other decentralized networks, the DNA DEX allows for
  real-time trading and is only limited by the speed of light and the size of
  the planet.
  
* **Provable Order Matching Algorithm**:
  What makes the DNA DEX unique is the provable order matching algorithm.
...
* **Collateralized Smartcoins**:
  One of the biggest features of DNA are its *smartcoins* such as bitUSD,
  ...
  backed by DNA' company shares (DNA) being locked up as collateral and
