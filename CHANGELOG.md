...
- #1699: Link to in-wallet help instead of docs.mvsdnadev.com
...
New features
--------
- Push new staging builds to https://staging.mvsdnadev.com using Travis
...
- #1481: Fix checkFeeStatusAsync duplicate asset resolution issues with DNA
...
- #359: Added green pulsing buy button when DNA is under 1 DNA
...
New features
--------
- #634 The hosted wallet is now available at wallet.mvsdnadev.com
...
Bug fixes
--------
- #658 DNA trade button missing from portfolio view
...
- Issue #364 - Present an error message that disallows the use of Incognito with the DNA wallet (#394)
...
Bug fixes
--------
- Fix #188: Total calculation (DNA) is not displayed correctly
...
- Fix a rounding issue when estimating non-DNA fees in the exchange
...
- A bug when importing old DNA 1 balances has been fixed
...
Bug fixes
--------
- Add DNA bloom filter for DNA 1 account imports
...
New features
--------
- Allow fees for order cancellation and shorting to be paid in assets other than DNA
...
- Update the Blocktrades bridge code to use the correct wallet symbols for MKR on the DNA blockchain
...
- Allow account upgrade, voting, permission changes and withdrawals to be paid in assets other than DNA if necessary #786
...
- Add base groups to MyMarkets: DNA, BTC, USD or CNY + others
...
- Remove link to DNA:DNA market in asset popover, fix asset description #709
...
NEW FEATURES:
- Option to pay fees in DNA if possible #356
...
- Show DNA balance in Accounts search results table #482
...
- Transfer Dialog does not fall back to DNA fee when there is no core exchange rate or funded fee pool #329
